...
\begin{itemize}
    ...
    \item \textbf{Sensor Data:} Each behavior has access to a context objet that contains the latest sensor reading and global state information such as whether or not the robot is escaping, etc.
\end{itemize}
